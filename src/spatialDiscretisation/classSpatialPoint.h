...
public:
    ...
    inline void setShapeFunctions(const vector<double>& f, const vector<double>& gradf)
    {
        phi = f;
        dphi = gradf;
    }
    ...
    virtual void updatePositionWithNodalDisplacement(const vector<double> &uK, int numNodes);
