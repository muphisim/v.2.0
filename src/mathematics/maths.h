...
public:
    ...
    virtual void luSolve(const vector<double>& rhs, vector<double>&res) = 0;
...
public:
    ...
    virtual void luSolve(const vector<double>& rhs, vector<double>&res);
...
public:
    ...
    virtual void luSolve(const vector<double>& rhs, vector<double>&res)
    {
      ERROR("classCRSMatrix::luSolve has not implemented!");
      exit(-1);
    }
...
extern void derivativeProductRandomConstantTensorRandomVariable(const vector<double> &A, const vector<double> &dTensorBdX, vector<double> &AdTensorBdX,const vector<double> &C_Stoch,const int ndim,const int nstoch);
