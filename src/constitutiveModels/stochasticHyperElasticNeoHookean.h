...
class classStochasticHyperElasticNeoHookean : public constitutiveModels {
    ...
    private:
        ...
        void build_derivatives_NeoHookean(const vector<double> &FCurr, vector<double> &dJdF, vector<double> &dFinvTdF, vector<double> &dtraceBdF, vector<double> &C_Stoch, const double tol, const int nstoch, const int ndim);
...
class classStochasticHyperElastic3DCompressibleNeoHookean : public constitutiveModels {
    ...
    private:
        void build_derivatives_CompressiveNeoHookean(const vector<double> &FCurr, vector<double> &dmuFinvTdF, vector<double> &dlambdalogJFinvTdF,  vector<double> &lambda_logJ, vector<double> &C_Stoch, const double tol, const int nstoch, const int ndim);
        void stress(vector<double> &PK2, vector<double> &PK1, const vector<double> &FCurr);
};
