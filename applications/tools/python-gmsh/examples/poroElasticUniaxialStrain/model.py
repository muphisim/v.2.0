    ...
    def __init__(self):
        ...
        self.solvers = ({
                ...
                "DispBC":(
                            ...
                            ("DISPLACEMENT RAMP",(3,13), ((1,0.),(2,0.))), 
                            ("DISPLACEMENT RAMP",(2,14), ((0,0),)),
                            ("DISPLACEMENT RAMP",(2,15), ((0,0),)),
                            ("DISPLACEMENT RAMP",(2,14), ((3,10.e6),)),
                         ), 
                "Extraction":(
        ...
        self.materials = ({
                ...
                # extra dof field
                "ExtraDof": ("DarcyLaw",(3.75E-5, 1E-5, 3.33E-1, 1.)),
